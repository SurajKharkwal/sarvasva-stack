...
export default function Home() {
  return (
    <div
      className={`${geistSans.className} ${geistMono.className} font-sans min-h-screen w-full flex flex-col items-center px-4 py-6 relative bg-white text-gray-900 dark:bg-neutral-950 dark:text-neutral-100`}
    >
      {/* Navbar */}
